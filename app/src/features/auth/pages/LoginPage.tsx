						...
						<div>
							...
							<div className="relative">
								...
								<input
									...
									required
									className="w-full bg-[#0f1729] border border-white/10 rounded-xl pl-10 pr-4 py-3 text-white placeholder-slate-600 focus:border-[#dc143c] focus:ring-1 focus:ring-[#dc143c] outline-none transition-all"
